export const data = [
    {
        ...
        price : 'Miễn phí',
        name : 'Tynker cơ bản',
        imglink : 'https://i.wingur.com/i7c8.png',
        description : 'Khóa học lập trình trực quan cơ bản bằng Tynker hỗ trợ các học sinh lớp 8. Khóa học cung cấp tất cả những kiến thức cần thiết về những điều cơ bản nhất trong Tynker và giúp học sinh tạo được sản phẩm đơn giản.'
    },
    {
        title : 'Lập trình trực quan',
        price : '200.000 VNĐ',
