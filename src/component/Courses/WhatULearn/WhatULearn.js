...
const WhatULearn = () => {
  return (
    <div className="component-margin">
      <div className="clp-component-render"><span id="objective" className="in-page-offset-anchor" />
        <div className="what-you-get">
          <div className="js-simple-collapse js-simple-collapse--what-you-get" data-purpose="course-objectives" data-more="See more">
            <div className="js-simple-collapse-inner">
              <div className="what-you-get__content">
                <div className="what-you-get__title udlite-heading-xl"> What you'll learn
                </div>
