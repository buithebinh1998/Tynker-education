...
const Navbar = props => {
  return(
    ...
    <div className="container">
      <NavLink className="navbar-brand" to="/"><img src = "https://i.wingur.com/i4Zo.png" alt ="Logo" style ={{width: '50px'}} />TynkerEdu <br /><span style={{fontSize: 16+'px',color:'red'}}>ĐẠI HỌC SƯ PHẠM</span></NavLink>
